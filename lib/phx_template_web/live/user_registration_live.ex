defmodule PhxTemplateWeb.UserRegistrationLive do
  ...
  def handle_event("save", %{"user" => user_params}, socket) do
    case Accounts.register_user(user_params) do
      {:ok, user} ->
        ...
        changeset = Accounts.change_user_registration(user)
        {:noreply, socket |> push_event("send_confirmation", %{email: user_email, url: url, message: message}) |> assign(trigger_submit: true) |> assign_form(changeset)}
